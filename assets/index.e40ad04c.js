...
`,x=t=>{const{yzlist:r,loading:n}=t;a.exports.useEffect(()=>{},[]);const l=()=>{console.log(666),window.scrollTo(0,0)},c=o("div",{className:"ListPage-contentTitle",children:"\u989C\u503C"}),u=r.map(s=>o(p,{video:s,showStatistics:!0},s.rid+Math.random()*1e5));return o(f,{children:i("div",{className:"video-list clear",children:[n?"":c,n?o(h,{style:{padding:"64px 0"},imageStyle:{width:375},description:"\u6682\u65E0\u6570\u636E"}):u,i("div",{className:"HomeFooter",children:[i("div",{className:"HomeFooter-goTop",onClick:l,children:[o("i",{className:"HomeFooter-goTopIcon"}),o("span",{className:"HomeFooter-goTopText",children:"\u8FD4\u56DE\u9876\u90E8"})]}),i("div",{className:"HomeFooter-officialDescription",children:[o("p",{className:"HomeFooter-officialDescriptionText",children:"\u5BA2\u670D\u70ED\u7EBF\uFF1A027-87750710"}),o("p",{className:"HomeFooter-officialDescriptionText",children:"\u6B66\u6C49\u6597\u9C7C\u7F51\u7EDC\u79D1\u6280\u6709\u9650\u516C\u53F8"}),o("p",{className:"HomeFooter-officialDescriptionText",children:"\u6E56\u5317\u7701\u6B66\u6C49\u5E02\u4E1C\u6E56\u5F00\u53D1\u533A\u5149\u8C37\u8F6F\u4EF6\u56EDF4\u680B8\u697C"}),o("p",{className:"HomeFooter-officialDescriptionText",children:"\u7248\u6743\u6240\u6709 \xA9 www.douyu.com \u9102ICP\u590715011961\u53F7-1"})]}),o("a",{className:"DownloadBtn",children:"\u6253\u5F00\u6597\u9C7CApp\uFF0C\u770B\u66F4\u591A\u7CBE\u5F69\u5185\u5BB9"})]})]})})},F=t=>({yzlist:t.homedata.yzlist,loading:t.homedata.loading}),b=t=>({getHomeDataActionDispatch(){t(g())}}),v=m(F,b)(a.exports.memo(x));export{v as default};
